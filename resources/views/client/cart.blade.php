							...
							<tbody>
								...
								<tr class="text-center">
								 ...
								 <form action="{{url('/modifier_qty/'.$product['product_id'])}}" method="POST">
									 ...
									 <input type="submit" value="Modifier" class="btn text-white" style="background-color: #bd2120"/>
    		...
    		<div class="row justify-content-end">
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
	              ...
	              <div class="form-group">
    				...
    				<p><a href="checkout.html" class="btn hi py-3 px-4">Apply Coupon</a></p>
    			</div>
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
	              ...
	              <div class="form-group">
    				...
    				<p><a href="checkout.html" class="btn hi py-3 px-4">Estimate</a></p>
    			</div>
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					<h3>Cart Totals</h3>
    				...
    				<p><a href="{{url('/paiement')}}" class="btn hi py-3 px-4">Proceed to Checkout</a></p>
    			</div>
    		</div>
			</div>
		</section> 
