      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
		      ...
		      <input type="submit" class="btn text-white " style="background-color: #bd2120" value="Payer"> 
	          	...
	          	<div class="col-md-12">
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<p><a href="#"class="btn text-white py-3 px-4" style="background-color: #bd2120">Place an order</a></p>
								</div>
	          	</div>
	          </div>
          </div> <!-- .col-md-8 -->
